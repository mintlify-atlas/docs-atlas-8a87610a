...
description: "Deep dive into AudioEngine.ts — the central Web Audio module for stem loading, synchronized playback, gain control, pitch shifting, and snapshot-based state."
---
