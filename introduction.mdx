...
| Layer | Technology |
|---|---|
| App framework | SvelteKit 2 with `@sveltejs/adapter-static` |
| UI runtime | Svelte 5 (runes syntax — `$state`, `$derived`, `$effect`, `$props`) |
| Language | TypeScript 6 |
| Build tool | Vite 8 |
| Audio engine | Web Audio API (`AudioContext`, `AudioBufferSourceNode`, `GainNode`) |
| Waveform rendering | WaveSurfer.js 7 with precomputed peak files |
| Pitch shifting | SoundTouch `@soundtouchjs/audio-worklet` |
| Tests | Vitest 4 — 17 test files, 100 tests |
